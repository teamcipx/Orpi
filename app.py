...
def register():
    ...
    if request.method == 'POST':
        ...
        # ক. একই ফিজিক্যাল ডিভাইস মডেল দিয়ে নিজের লিংকে নিজে জয়েন করার ট্রাই করলে
        ...
        # খ. একই জিপিইউ/অডিও ফিঙ্গারপ্রিন্ট হ্যাশ দিয়ে নিজের লিংকে নিজে জয়েন করার ট্রাই করলে
        if referrer_fingerprint and device_fingerprint:
            ...
            is_generic_fp = my_fp_clean in ["undefined", "null", "none", ""] or len(my_fp_clean) < 5
        ...
        try:
            ...
            if new_user_res.data:
                ...
                if referrer_id:
                    ...
                    # যদি চিটিং বা সেলফ-রেফারেল সনাক্ত হয়, তবে নীরবে রেফারেল বাতিল (Failed) হবে, কোনো বোনাস যোগ হবে না
                    if is_cheating:
                        status = "Failed"
                    else:
                        # চিটিং না থাকলে স্বাভাবিক ৮০% সাকসেস প্রোবাবিলিটি রোল কার্যকর হবে
